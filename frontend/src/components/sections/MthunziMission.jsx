        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-5xl font-black text-blue-900 mb-6 leading-tight uppercase tracking-tighter">
                Mthunzi Trust is a registered
                <span className="text-primary-green"> Youth-Led </span>
                Non-Profit Organisation
              </h2>
              <p className="text-gray-500 text-base md:text-xl mb-10 leading-relaxed font-medium">
