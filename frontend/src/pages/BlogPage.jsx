  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-center overflow-hidden bg-blue-900">
        ...
        <div className="container mx-auto px-4 z-30 relative pt-32">
          <div className="max-w-4xl">
            ...
            >
              <span className="inline-block px-4 py-1.5 rounded-full bg-primary-green/20 backdrop-blur-md border border-primary-green/30 text-primary-green text-sm font-bold uppercase tracking-widest mb-6">
                Our Stories
              </span>
            ...
            >
              ...
              {featuredPost && (
                <div className="mb-16">
                  ...
                  <Link
                    ...
                    className="block group relative h-[500px] rounded-[40px] overflow-hidden shadow-2xl"
                  >
                    <img
                    ...
                    <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full md:w-3/4">
                      ...
                      <div className="flex items-center gap-3 bg-white text-blue-900 w-fit px-8 py-4 rounded-2xl font-black hover:bg-primary-yellow transition-all">
                ...
                {regularPosts.map((post, idx) => (
                  ...
                  >
                    <motion.div
                      ...
                      whileHover={{ y: -12 }}
                      className="bg-white rounded-[2.5rem] overflow-hidden shadow-2xl shadow-blue-900/5 hover:shadow-primary-green/20 border border-gray-100/50 hover:border-primary-green/30 transition-all duration-500 h-full flex flex-col"
                    >
                      ...
                      <div className="p-10 flex-grow flex flex-col">
                        ...
                        <div className="flex items-center gap-4 text-[11px] text-gray-400 mb-6 font-bold uppercase tracking-widest bg-gray-50/50 p-3 rounded-2xl border border-gray-100/50">
                        ...
                        <h3 className="text-2xl font-black text-blue-900 group-hover:text-primary-green transition-colors duration-300 leading-[1.3] mb-8">
                          {post.title}
                        </h3>

                        {/* Premium Button Footer */}
                        <div className="mt-auto pt-6 border-t border-gray-50/80 flex items-center justify-between group/btn">
                          <div className="flex items-center gap-2 text-primary-green font-black text-sm uppercase tracking-wider">
                          ...
                          <div className="w-10 h-10 rounded-full bg-primary-green/5 group-hover:bg-primary-green flex items-center justify-center transition-all duration-300">
              ...
              {blogPosts.length >= 6 && (
                <div className="mt-16 text-center">
                  <button className="bg-white text-blue-900 border-2 border-blue-900/10 px-10 py-4 rounded-2xl font-black hover:bg-blue-900 hover:text-white transition-all shadow-xl shadow-blue-900/5">
                    Load More Articles
                  </button>
                </div>
              )}
      ...
      <section className="container mx-auto px-4 mt-32">
        <div className="bg-blue-900 rounded-[50px] p-8 md:p-16 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-2xl">
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight">
              ...
              to your{" "}
              <span className="text-primary-yellow text-glow">inbox.</span>
            </h2>
            ...
            <form className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-grow bg-white/10 border-2 border-white/20 rounded-2xl px-6 py-4 text-white placeholder-white/40 focus:outline-none focus:border-primary-yellow transition-all"
              />
              <button className="bg-primary-yellow text-blue-900 px-8 py-4 rounded-2xl font-black hover:bg-white transition-all shadow-lg">
                Subscribe Now
              </button>
            </form>
